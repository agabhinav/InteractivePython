...
#        canvas.draw_circle(self.pos, self.radius, 1, "White", "White")
    ...
    def toggle_thrusters(self, thrust):
        self.thrust = thrust
        if thrust:
...
def draw(canvas):
    ...
    canvas.draw_text("Lives " + str(lives), [15, 35], 30, 'White')
    canvas.draw_text("Score " + str(score), [690, 35], 30, 'White')
...
def rock_spawner():
    ...
    #velocity, position, and angular velocity randomly for the rock
    pos = [random.randrange(0, WIDTH), random.randrange(0, HEIGHT)]
    vel = [random.randrange(-2, 2), random.randrange(-2, 2)]
    ang_vel = random.randrange(-2,3,1)/10
